 ...
 * com.beowulfe.hap.characteristics} when creating custom accessory types (the standard accessories
 * from {@link com.beowulfe.hap.accessories} already include the necessary characteristics), instead
 * of trying to implement the JSON formats directly.
 *
 * @author Andy Lintner
 */
